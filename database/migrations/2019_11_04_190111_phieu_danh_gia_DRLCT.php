...
class PhieuDanhGiaDrlct extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        /*Điểm số của các chi tiết trên phiếu đánh giá điểm rèn luyện chi tiết*/
        Schema::create('phieu_danh_gia_drlct', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('phieu_danh_gia_drlct');
    }
}
