...
var validator = (function($){
    ...
    */
    message = {
        ...
        checked         : 'Phải chọn mục này',
        empty           : 'Hãy điền thông tin vào trường này',
        min             : 'Thông tin quá ngắn',
        max             : 'Thông tin quá dài',
        number_min      : 'Thông tin quá thấp',
        number_max      : 'Thông tin quá cao',
        url             : 'Đường dẫn URL không hợp lệ',
        number          : 'Thông tin không phải số',
        email           : 'Địa chỉ email không hợp lệ',
        email_repeat    : 'Địa chỉ email không khớp',
        password_repeat : 'Mật khẩu không khớp',
        repeat          : 'Không khớp',
        complete        : 'Thông tin chưa đầy dủ',
        select          : 'Vui lòng chọn một tuỳ chọn'
    };
    ...
    */
    ...
    function checkFieldForCheckBox(object){
        // skip testing fields whom their type is not HIDDEN but they are HIDDEN via CSS.
        if(object.type !='hidden' && $(object).is(':hidden') )
            return true;

        prepareFieldData(object);
    ...
    */
    ...
    return {
        ...
        checkFieldForCheckBox: checkFieldForCheckBox,
        keypress    : keypress,
        checkAll    : checkAll,
        mark        : mark,
        unmark      : unmark,
