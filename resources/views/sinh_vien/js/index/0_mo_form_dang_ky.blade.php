...
$(function(){
	try
	{
		...
		/*click button mở form đăng ký trên thông báo lớp*/
		if($('#div__id__thongBaoLop').length)
			$('#div__id__thongBaoLop').on('click', '[data-button-id="button__data-button-id__dangKy"]', function(){
	            try
	            {
		            $('#div__id__bieuMauDangXML').slideDown(800);
		            $('html, body').animate({
