...
$(function(){
	try
	{
		...
		function init_DataTablesTienDoHT(){
			try
			{
				if(console.log("run_datatablesTienDoHT"),"undefined"!=typeof $.fn.DataTable)
				{
	    			...
	    			$('<div class="col-sm-4" id="div__id__div_button_parent_tienDoHT_1"></div>').insertAfter($('[data-id="div__id__button_group"]')[0]);
	    			...
	    			$('#div__id__div_button_parent_tienDoHT_2').append($('[data-id="div__id__button_group"]')[0]);
	    			...
	    			/*Copy button*/
	    			$($($('[data-id="div__id__button_group"]')[0]).children()[0]).attr('data-id', 'button__id__saoChep_tienDoHT');
	    			...
	    			/*Export excel button*/
	    			$($($('[data-id="div__id__button_group"]')[0]).children()[1]).attr('data-id', 'button__id__excel_tienDoHT');
	    			...
	    			/*Export pdf button*/
	    			$($($('[data-id="div__id__button_group"]')[0]).children()[2]).attr('data-id', 'button__id__pdf_tienDoHT');
		...
		if($('#tbody__id__sinhVien').length)
			$('#tbody__id__sinhVien').on('click', '[data-button="xemTienDoHT"]', function(){
				try
	            {
