...
"Đã sao chép vào bộ nhớ tạm!"),b.i18n("buttons.copySuccess",{1:"Đã sao chép 1 hàng vào bộ nhớ tạm.",_:"Đã sao chép %d hàng vào bộ nhớ tạm."},a.rows),2E3);return}catch(f){}}a=g("<span>"+b.i18n("buttons.copyKeys","Nhấn <i>ctrl</i> or <i>⌘</i> + <i>C</i> để sao chép dữ liệu bảng<br>sang bộ nhớ tạm.<br><br>Để huỷ, nhấp vào thông báo ngày hoặc nút Escape.")+"</span>").append(d);b.buttons.info(b.i18n("buttons.copyTitle","Đã sao chép vào bộ nhớ tạm!"),a,0);c[0].focus();c[0].select();var h=g(a).closest(".dt-button-info"),j=function(){h.off("click.buttons-copy");
g(i).off(".buttons-copy");b.buttons.info(false)};h.on("click.buttons-copy",j);g(i).on("keydown.buttons-copy",function(a){a.keyCode===27&&j()}).on("copy.buttons-copy cut.buttons-copy",function(){j()})},exportOptions:{},fieldSeparator:"\t",fieldBoundary:"",header:!0,footer:!1};s.ext.buttons.csvHtml5={className:"buttons-csv buttons-html5",available:function(){return j.FileReader!==m&&j.Blob},text:function(a){return a.i18n("buttons.csv","Xuất ra Excel")},action:function(a,b,d,c){a=L(b,c).str;b=c.charset;c.customize&&
