...
@section('content')
    <div class="main-content">
        ...
        <input type="hidden" id="id_nv" value="{{$nd->nhanVien->IdNV}}">
                ...
                <section class="p-t-20 hidden" id="formdkk">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="m-b-35">
                                    <h3 class="title-5 font-weight-bold text-green">LẬP PHIẾU ĐĂNG KÝ KHÁM BỆNH</h3>
                                                        ...
                                                        <div class="col-lg-2">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" id="htk">
                                                                    <option value="0">Khám BHYT</option>
                                                                    <option value="1">Khám thu phí</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-3">
                ...
                <!-- DANH SÁCH PHIẾU VỪA THÊM-->
                <section class="p-t-20">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="m-b-35">
                                    <h3 class="title-5 font-weight-bold text-green">DANH SÁCH PHIẾU ĐĂNG KÝ KHÁM BỆNH HÔM NAY</h3>
                                    <hr class="line-seprate">
                                </div>
                                    ...
                                    <div class="table-data__tool-right">
                                        <div class="row">
                                            <div class="col-lg-4 m-b-15">
                                                <button type="button"  class="au-btn au-btn--darkyellow au-btn--small au-btn-shadow height-40px" data-toggle="tooltip" title="Thêm mới" id="btnadd"><i class="fa fa-paper-plane-o"></i></button>
                                            </div>
                                            <div class="col-lg-4 m-b-15">
                    ...
                    <div class="modal-dialog modal-sm" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">In phiếu đăng ký khám</h5>
                                    ...
                                    <div class="card-body card-block" id="printcontent" style="padding: 0;">
                                        ...
                                        <div class="row text-center" style="font-size: 11pt;">
                                            <div class="col-lg-12" style="margin: 0;">
                                                <label style="margin: 0;"><?php echo mb_convert_case('khám thứ tự - số:', MB_CASE_UPPER,'utf-8');?></label> <label id="sttkham" style="margin: 0; font-weight: 700;"></label>
                                            </div>
                                        </div>
                                        <div class="row text-center">
                                            <div class="col-lg-12" style="margin: 0;">
                                        ...
                                        <div class="row text-center" style="font-size: 9pt; margin: 0;">
                                            ...
                                            <div class="col-lg-7">
                                                <label style="margin: 0;">Ngày Khám:</label> <label id="lblngaydk" style="margin: 0; font-weight: 600;"></label>
                                            </div>
                                        </div>
...
<script>
    $(function () {
        ...
        $('#khoa').change(function(){
            ...
            $.ajax({
                type: 'post',
                url: "/qlkcb/tiep_don/dang_ky_kham/lay_ds_phong",
                dataType: 'JSON',
                data: {_token: CSRF_TOKEN, idkhoa: id},
                success: function(data){
                    $('#phong').html(data.msg);
                },
                error: function (jqXHR, textStatus, errorThrown) {
                    alert("Không thể lấy danh sách khoa. Lỗi: "+jqXHR+" | "+errorThrown);
                }
            });
        });
        //end Lấy danh sách khoa
        ...
        $('#btnthem').click(function(){
            ...
            $.ajax({
                ...
                success: function(data) {
                    // Success
                    if(data.msg == 'tc'){
                        alert("Thêm phiếu đăng ký khám thành công!");
                        $('input[data-input="checksum"]').prop("checked",false);
                        $('input[data-input="check"]').prop("checked",false);
                        $('#kqtimliem').text("");
                        ...
                        alert("Bệnh nhân đã đăng ký khám khoa này!!");
                    }
                        ...
                        alert("Thêm phiếu đăng ký khám thất bại! Lỗi: "+data.msg);
                    }
                },
                error: function(jqXHR, textStatus, errorThrown) {
                    $('#btninarea').fadeOut(800);
        ...
        $('#btncapnhat').click(function(){
            ...
            $.ajax({
                ...
                success: function(data) {
                    // Success
                    if(data.msg == 'tc'){
                        alert("Cập nhật thông tin phiếu đăng ký khám thành công!");
                    }
                    else if(data.msg == 'da_lap_ba'){
                        alert("Phiếu đăng ký khám này đã lập bệnh án, không cập nhật được!");
                    }
                    else{
                        alert("Cập nhật thông tin phiếu đăng ký khám thất bại! Lỗi: "+data.msg);
                    }
                },
                error: function(jqXHR, textStatus, errorThrown) {
                    if(jqXHR.status == 419){
                        alert("Cập nhật thông tin phiếu đăng ký khám thất bại! Người dùng không được xác thực (có thể đã đăng xuất).");
                    }
                    else if(jqXHR.status == 500){
                        alert("Cập nhật thông tin phiếu đăng ký khám thất bại! Đã phát hiện lỗi trên máy chủ phục vụ.");
                    }
                    else{
                        alert("Cập nhật thông tin phiếu đăng ký khám thất bại! Lỗi: "+jqXHR.responseText+" | "+textStatus+" | "+errorThrown);
                    }
                }
            });
        });
        ...
        $('#btnadd').click(function(){
            ...
            $('#formtitle').text('LẬP PHIẾU ĐĂNG KÝ KHÁM BỆNH');
            $('#btnlamlai').click();
            $("#khoa").change();
                    ...
                    success: function(data) {
                        ...
                        if(data.msg == 'tc'){
                            if(data.flag == false){
                                ...
                                alert("Phiếu đăng ký khám này đã lập bệnh án, không xóa được!");
                            }
                        }
                        else{
        ...
        $('#tbl_phieudk').on('click','button[data-button="sua"]',function(){
            ...
            $('#formtitle').text('CẬP NHẬT THÔNG TIN PHIẾU ĐĂNG KÝ KHÁM BỆNH');
        ...
        //lọc danh sách
        $('#khoa_f').change(function (){
            $('input[data-input="checksum"]').prop("checked",false);
            $('input[data-input="check"]').prop("checked",false);
            
            var formData = new FormData();
            formData.append('_token', CSRF_TOKEN);
            formData.append('khoa', $(this).val());
                            ...
                            if(data.msg == 'tc'){
                                if(arr.length > 1){
                                    if(data.flag ==  false){
                                        ...
                                        alert("Một số phiếu đăng ký khám đã lập bệnh án, những phiếu này không xóa được!");
                                    }
                                    $('input[data-input="checksum"]').prop("checked",false);
                    ...
                    $.ajax({
                        ...
                        error: function(jqXHR, textStatus, errorThrown) {
                            ...
                            if(flag == true) //lấy thông tin cập nhật
                            {
                                ...
                                $('.thearea').removeClass('hidden');$('#htk').removeAttr('disabled');
