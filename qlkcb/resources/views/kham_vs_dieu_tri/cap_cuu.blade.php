...
@section('content')
    <div class="main-content">
                                                                ...
                                                                @if(isset($dschotn))
                                                                    @foreach($dschotn as $tn)
                                                                        <option 
                                                                            ...
                                                                            data-tuyen="{{$tuyen}}"
                                                                            data-giaychuyen="{{$giaychuyen}}"
                                                                            data-chuyentu="{{$chuyentu}}"
                                                                            data-khambhyt="co"
                                                                            @else
                                                                                data-khambhyt="ko"
                                                                            @endif
        ...
        <!-- END DANH SÁCH CHỜ TIẾP NHẬN CC-->
        ...
        <section class="p-t-20 hidden" id="formba">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class=" m-b-35">
                            <h3 class="title-5 font-weight-bold text-green" id="formtitle">LẬP BỆNH ÁN CẤP CỨU</h3>
                            <hr class="line-seprate">
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                                    ...
                                    <div class="card-body card-block">
                                        ...
                                        <i class="fa fa-minus"></i></button>
                                            ...
                                            <div class="row m-b-15">
                                                ...
                                                <div class="col-lg-1 hidden" id="btngiayrv">
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <datalist id="dstenthuoc">
                                                            @if(isset($dsthuoc))
                                                                ...
                                                                <option data-dvt="{{$thuoc->danhMucThuoc->DonViTinh}}" data-value="{{$thuoc->danhMucThuoc->IdThuoc}}" value="{{$thuoc->danhMucThuoc->TenThuoc}}">{{$thuoc->danhMucThuoc->ThanhPhan}}</option>
                                                                @endforeach
                                                            @endif
                                                        </datalist>
        ...
        <!--MODAL NHẬN BỆNH ÁN-->
        <div class="modal fade" id="modalnhanba" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel" aria-hidden="true" data-backdrop="static">
            <div class="modal-dialog modal-lgest" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="largeModalLabel">NHẬN BỆNH ÁN CHUYỂN ĐẾN</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close" data-toggle="tooltip" title="Đóng">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                                    ...
                                    <div class="card-body card-block">
                                        <form>
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <label class=" form-control-label">Danh sách bệnh án chờ tiếp nhận</label>
                                                        <div class="row">
                                                            <div class="col-lg-8 m-b-15">
                                                                <select class="form-control" id="dsbacd">
                                                            ...
                                                            <div class="col-lg-1">
                                                                <div class="form-group" >
                                                                    <button type="button" class="au-btn au-btn--blue au-btn--small au-btn-shadow height-40px" data-toggle="tooltip" title="Nhận bệnh án này" id="btnnhanba"><span class="fa fa-cloud-download"></span></button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <table class="table table-data2 table-hover m-b-20 text-center">
                                <thead>
                                    <tr>
                                        ...
                                        <th>tình trạng bệnh nhân lúc chuyển</th>
        ...
        <section class="p-t-20">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class=" m-b-35">
                            <h3 class="title-5 font-weight-bold text-green">DANH SÁCH BỆNH ÁN CẤP CỨU - KHOA [{{$tenkhoa}}] - BS. {{$tennv}}</h3>
                            <hr class="line-seprate">
                        </div>
                        ...
                        <div class="table-data__tool">
                            ...
                            <div class="table-data__tool-right">
                                <button type="button" class="au-btn au-btn--green au-btn--small au-btn-shadow height-40px hidden" data-toggle="modal" data-target="#modalnhanba"><i class="fa fa-cloud-download" data-toggle="tooltip" title="Tiếp nhận bệnh án chuyển đến"></i></button>
...
<script>
    $(function () {
        ...
        var tk=false, keySearch='', soluongtk=0, soluongl=0, locds=false, htbn=false, bnddd=false, themba=false, flagcls=false, flagtt=false, flagpt=false, file_name_tt='', tstrangtt = 1, dskham='', giuongc='', flagthe=false;
        //end
        ...
        var channeldtcc = pusher.subscribe('CapCuu');
        ...
        channeldtcc.bind('App\\Events\\KhamVaDieuTri\\CapCuu', layttbac);
        ...
        function layttdk(data) {
            if(data.thaotac != 'xoa'){
                if($('#idphong').val() == data.dkkham.idphong){
                    ...
                    if(data.dkkham.khambhyt == true){
                            pdk+='data-tuyen="'+data.dkkham.t+'"\n\
                            data-giaychuyen="'+data.dkkham.giaychuyen+'"\n\
                            data-chuyentu="'+data.dkkham.chuyentu+'"\n\
                            data-khambhyt="co"';
                    }
                    else{
                         pdk+='data-khambhyt="ko"';
                    }
        ...
        channelcc.bind('App\\Events\\TiepDon\\CapCuu', layttdk);
            ...
            if(data.thaotac != 'xoa'){
                ...
                if(data.pk != null){
                    ...
                    $.ajax({
                        type: 'POST',
                        dataType: "JSON",
                        url: '/qlkcb/kham_va_dieu_tri/benh_an_noi_tru/lay_ds_pk_da_tn',
                        xhr: function() {
                            var myXhr = $.ajaxSettings.xhr();
                            return myXhr;
                        },
                        ...
                        success: function(data) { 
                            ...
                            if(data.msg == 'tc'){
                                ...
                                for (var i = 0; i < data.pk.length; i++) {
                                    ...
                                    if(data.pk[i]['khambhyt'] == true){
                                            pdk+='data-tuyen="'+data.pk[i]['t']+'"\n\
                                            data-giaychuyen="'+data.pk[i]['giaychuyen']+'"\n\
                                            data-chuyentu="'+data.pk[i]['chuyentu']+'"\n\
                                            data-khambhyt="co"';
                                    }
                                    else{
                                         pdk+='data-khambhyt="ko"';
...
//         Đăng ký kênh kết quả chỉ định thủ thuật 
        ...
        $('#btntiepnhan').click(function (){
            if($('#dschotn').children().length > 0){
                $('#dschuadoan').html('');$('#lydonv').val('');$('#ghichuba').val('');
                ...
                khambhyt=$('#dschotn option[value="'+mapdk+'"').attr('data-khambhyt'),
                t=$('#dschotn option[value="'+mapdk+'"').attr('data-tuyen'),
                chuyentu=$('#dschotn option[value="'+mapdk+'"').attr('data-chuyentu'),
                giaychuyen=$('#dschotn option[value="'+mapdk+'"').attr('data-giaychuyen');

                $('#formtitle').text('LẬP BỆNH ÁN CẤP CỨU');
                ...
                if(khambhyt == 'co'){
                    $('#tuyen').val(t);$('#giaychuyen').val(giaychuyen);$('#chuyentu').val(chuyentu);
                }
                $('#btnthemarea').fadeIn(800);$('#btnsuaarea').fadeOut(800);$('#btnxemctgdarea').fadeOut(800);$('#btngiayrv').fadeOut(800);$('#btnlapphieukkarea').fadeOut(800);$('#btnchuyenbaarea').fadeOut(800);$('#btngcvarea').fadeOut(800);
...
//                     Success
        ...
        $('#btnthem').click(function(){
            ...
            var mabn=$('#hoten').attr('data-id'), lydonv=$('#lydonv').val(), trangthaibn=$('#tinhtrangbn').val(), ghichu=$('#ghichuba').val(), mapdk=$(this).attr('data-idpdk'), giuong=$('#dsgiuong').val();
            ...
            $.when(ktba(mabn, mapdk)).done(function (){
                if(bnddd == true){
                    ...
                    $.ajax({
                        type: 'POST',
                        dataType: "JSON",
                        url: '/qlkcb/kham_va_dieu_tri/cap_cuu/them_moi',
                        xhr: function() {
                            var myXhr = $.ajaxSettings.xhr();
                            return myXhr;
                        },
        ...
        //                     Success
                            if(data.msg == 'tc'){
                                ...
                                $('#btnxemctgdarea').fadeIn(800);$('#btngiayrv').fadeIn(800);$('#btnlapphieukkarea').fadeIn(800);$('#btnchuyenbaarea').fadeIn(800);
                                
                                $('#dschotn option[data-idbn="'+mabn+'"]').remove();
                                themba=false;
                                
                                $('#btnxemctgd').attr('data-id', data.idba);
                                $('#btngiayrv').attr('data-id', data.idba);
                            ...
                            else if(data.msg =='dang_dieu_tri'){
                                alert("Bệnh đang điều trị trong khoa này!");
                            }
                            else{
                                themba=true;
                                $('#btnxemctgd').attr('data-id', '');
                                $('#btngiayrv').attr('data-id', '');
        ...
        $('#tbl_banoi').on('click', 'button[data-button="btnxoa"]', function(){
            ...
            if(cf==true){
                if($('#formba').css('display') == 'block' && (id == $('#btncapnhat').attr('data-id') || id == $('#btnxemctgd').attr('data-id'))){//đóng form sửa khi click xóa
                   $('#btndong').click();
                }
                var formData = new FormData();
                formData.append('_token', CSRF_TOKEN);
        ...
        $('#tbl_banoi').on('click','button[data-button="btnsua"]',function(){
            $('#btnthemarea').fadeOut(800);$('#btnsuaarea').fadeIn(800);$('#btnxemctgdarea').fadeIn(800);$('#btngiayrv').fadeIn(800);$('#btnlapphieukkarea').fadeIn(800);
            var formData = new FormData();
            var id=$(this).attr('data-id');
            formData.append('_token', CSRF_TOKEN);
            formData.append('id', id);
            ...
            $.ajax({
                ...
                success: function(data) {
                    if(data.msg == 'tc')
                    {
                        ...
                        $('#tinhtrangbn').val(data.tinhtrangbn);$('#ghichuba').val(data.ghichu);
               ...
               var name='';var arr=[],arr_name=[];
                ...
                if(cf==true){
                    for (var i = 0; i < arr.length; i++) {
                        if($('#formba').css('display') == 'block' && (arr[i] == $('#btncapnhat').attr('data-id') || arr[i] == $('#btnxemctgd').attr('data-id'))){//đóng form sửa khi click xóa
                           $('#btndong').click();
                        }
                    }
                    var formData = new FormData();
