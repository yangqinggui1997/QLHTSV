            ...
            <section class="p-t-20">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class=" m-b-35">
                                <h3 class="title-5 font-weight-bold text-green">DANH SÁCH TOA THUỐC NỘI TRÚ - KHOA [{{mb_convert_case($nd->nhanVien->phongBan->Khoa->TenKhoa, MB_CASE_UPPER, 'UTF-8')}}] - BS. {{mb_convert_case($nd->nhanVien->TenNV, MB_CASE_UPPER, 'UTF-8')}}</h3>
                                        ...
                                        <tr class="tr-shadow">
                                            <td style="vertical-align: middle;">
                                                <label class="au-checkbox" style="margin-top: 0; margin-bottom: 20px;">
                                                    <input type="checkbox" data-input="check" data-id="{{ $toa->IdTT }}" data-name="<?php echo $toa->benhAnNoiTruCT->benhAnNoiTruCT->benhAnNoiTru->phieuDKKham->phieuDKKham->benhNhan->HoTen; ?>">
                                                    <span class="au-checkmark"></span>
                                                </label>
                                            </td>
                                            <td>{{$toa->benhAnNoiTruCT->benhAnNoiTruCT->benhAnNoiTru->phieuDKKham->phieuDKKham->benhNhan->HoTen}}</td>
                                            <td>
                                                @if($toa->benhAnNoiTruCT->benhAnNoiTruCT->benhAnNoiTru->phieuDKKham->phieuDKKham->KhamBHYT == 0)
                                                BHYT
                                                @else
                                                Thu phí
                                                @endif
                                            ...
                                            <td class="text-left">
                                                @foreach($toa->benhAnNoiTruCT->benhAnNoiTruCT->benhAnNoiTru->chuanDoan as $cd)
                                            ...
                                            <td>
                                                <div class="table-data-feature">
                                                    ...
                                                    <button type="button" class="item" data-toggle="tooltip" data-placement="top" title="Xóa" data-button="btnxoa" data-id="{{$toa->IdTT}}" data-name="{{$toa->benhAnNoiTruCT->benhAnNoiTruCT->benhAnNoiTru->phieuDKKham->phieuDKKham->benhNhan->HoTen}}">
            ...
            <section class="p-t-20">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class=" m-b-35">
                                <h3 class="title-5 font-weight-bold text-green">DANH SÁCH TOA THUỐC NỘI TRÚ - DS. {{mb_convert_case($nd->nhanVien->TenNV, MB_CASE_UPPER, 'UTF-8')}}</h3>
                                <hr class="line-seprate">
                            </div>
                            <div class="table-data__tool">
                                <div class="table-data__tool-left">
                                ...
                                <table class="table table-data2 table-hover m-b-20 text-center">
                                    ...
                                    <tbody id="tbl_toathuoc">
                                        ...
                                        <tr class="tr-shadow">
                                            ...
                                            <td>{{$toa->benhAnNoiTruCT->benhAnNoiTruCT->benhAnNoiTru->nhanVien->TenNV}}</td>
                                            <td class="text-left">
                                                @foreach($toa->benhAnNoiTruCT->benhAnNoiTruCT->benhAnNoiTru->chuanDoan as $cd)
                                                    {{'- '.$cd->danhMucBenh->TenBenh}}<br>
                                                @endforeach
                                    ...
                                    <i class="fa fa-list-alt"></i>
                                                    ...
                                                    <button type="button" class="item" data-toggle="tooltip" data-placement="top" title="Xác nhận đã lãnh thuốc" data-button="btnxnlanhthuoc" data-id="{{$toa->IdTT}}" data-name="{{$toa->benhAnNoiTruCT->benhAnNoiTruCT->benhAnNoiTru->phieuDKKham->phieuDKKham->benhNhan->HoTen}}">
    ...
    $(function () {
        ...
        $('#tbl_toathuoc').on ('click', 'button[data-button="btnxnlanhthuoc"]', function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: '/qlkcb/kham_va_dieu_tri/toa_thuoc_noi_tru/xac_nhan_lt',
                xhr: function() {
        ...
        $('#btntimkiem').click(function (){
            ...
            var url='/qlkcb/kham_va_dieu_tri/toa_thuoc_noi_tru/tim_kiem';
            if($('#loaind').val().toString() == 'pt'){
                url='/qlkcb/kham_va_dieu_tri/toa_thuoc_noi_tru/tim_kiem_nvpt';
            }
            $.ajax({
                type: 'POST',
                dataType: "JSON",
...
//                            $('#btnlocds').tooltip('hide').attr('data-original-title', 'Lọc danh sách tìm kiếm').tooltip('fixTitle').tooltip('show');
        ...
        $('#btnnapds').click(function(){
            ...
            var formData = new FormData();
            formData.append('_token', CSRF_TOKEN);
            var url='/qlkcb/kham_va_dieu_tri/toa_thuoc_noi_tru/lay_ds_toa';
            if($('#loaind').val().toString() == 'pt'){
                url='/qlkcb/kham_va_dieu_tri/toa_thuoc_noi_tru/lay_ds_toa_nvpt';
            }
            $.ajax({
                type: 'POST',
                dataType: "JSON",
