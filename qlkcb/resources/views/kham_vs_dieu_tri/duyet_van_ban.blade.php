...
<script>
    ...
    $(function () {
        ...
        function layttbac(data) {
            if(data.tt == 'them'){
                ...
                $.ajax({
                    ...
                    {
                        // exists
                        audiocba = new Audio('public/audios/sound.mp3');
                        audiocba.play();
                    }
                });
            }
            ...
            if(data.thaotac != 'xoa'){
                ...
                if(data.thaotac == 'duyet'){
                    if(data.dvb.idnvd == $('#id_nv').val()){
                        ...
                        if(data.dvb.pl == 'grv' && data.dvb.idnv ==$('#id_nv').val()){
                            ttdm='\n\
                            <tr class="tr-shadow">\n\
                                <td style="vertical-align: middle;">\n\
                                    <label class="au-checkbox" style="margin-top: 0; margin-bottom: 20px;">\n\
        ...
        $('#tbl_cd').on('click', 'button[data-button="xoa"]', function(){
            ...
            var cf=confirm("Bạn có thực sự muốn xóa báo cáo ["+name+"]?");
            if(cf==true){
                        ...
                        if(data.msg == 'tc'){
                            if(locds == true){
                                ...
                                if(soluongl == 0){
                                    ...
                                    $('#kqtimliem').text("Có "+soluongl+" báo cáo được tìm thấy!");
                                }
                            }
                            else{
                                if(tk == true){
                                    ...
                                    if(soluongtk == 0){
                                        ...
                                        $('#kqtimliem').text("Có "+soluongtk+" báo cáo được tìm thấy!");
                                    }
                                }
                            }
                            if($('#quyen_bs').val() == 'FALSE'){
                            ...
                            alert("Xóa thông tin báo cáo thành công!");
                        }
                        else{
                            alert("Xóa thông tin báo cáo thất bại! Lỗi: "+data.msg);
                        }
                    },
                    error: function(jqXHR, textStatus, errorThrown) {
                        if(jqXHR.status == 419){
                            alert("Xóa thông tin báo cáo thất bại! Người dùng không được xác thực (có thể đã đăng xuất).");
                        }
                        else if(jqXHR.status == 500){
                            alert("Xóa thông tin báo cáo thất bại! Đã phát hiện lỗi trên máy chủ phục vụ.");
                        }
                        else{
                            alert("Xóa thông tin báo cáo thất bại! Lỗi: "+jqXHR.responseText+" | "+textStatus+" | "+errorThrown);
                        }
                    }
                });
            }
             ...
             $.ajax({
                 ...
                 error: function(jqXHR, textStatus, errorThrown) {
                    if(jqXHR.status == 419){
                        ...
                        alert("Duyệt báo cáo thất bại! Lỗi: "+jqXHR.responseText+" | "+textStatus+" | "+errorThrown);
                    }
                    $('#proccess').addClass('hidden');
                    $('#dtbiarea').addClass('hidden');
                 }
        ...
        $('#btntimkiem').click(function (){
            ...
            if($('#quyen_bs').val() == 'FALSE'){
                formData.append('loaiform', 'kvdtt');
            }
            else{
                formData.append('loaiform', 'kvdt');
                if($('#custom-nav-profile-tab').attr('aria-selected') == 'true'){
